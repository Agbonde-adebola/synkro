...
Every session tracks LLM calls, costs, and timing per pipeline phase:
...
# Phase             Cost      Calls       Time
# --------------------------------------------------
# extraction       $0.0120        1      18.7s
# scenarios        $0.0082        3       6.1s
# traces           $0.2341       30      45.2s
# verification     $0.1823       30      38.1s
# --------------------------------------------------
# Total            $0.4265       75
...
print(session.metrics.breakdown)       # {'extraction': 0.012, 'scenarios': 0.008, ...}
```
